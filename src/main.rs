...
fn post_message_interactive(queue: &MessageQueue, topics_created: &mut std::collections::HashMap<String, usize>) {
    use std::io::{self, Write};
...
fn view_topics(topics_created: &std::collections::HashMap<String, usize>) {
...
fn run_demo(queue: &MessageQueue, topics_created: &mut std::collections::HashMap<String, usize>) {
